...
type DictionaryQuery struct {
	...
	withItems  *DictionaryDetailQuery
...
func (_q *DictionaryQuery) WithItems(opts ...func(*DictionaryDetailQuery)) *DictionaryQuery {
	query := (&DictionaryDetailClient{config: _q.config}).Query()
...
//		GroupBy(dictionary.FieldCreatedByID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Dictionary.Query().
//		Select(dictionary.FieldCreatedByID).
//		Scan(ctx, &v)
...
func (_q *DictionaryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Dictionary, error) {
	...
	if query := _q.withItems; query != nil {
		if err := _q.loadItems(ctx, query, nodes,
			func(n *Dictionary) { n.Edges.Items = []*DictionaryDetail{} },
			func(n *Dictionary, e *DictionaryDetail) { n.Edges.Items = append(n.Edges.Items, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DictionaryQuery) loadItems(ctx context.Context, query *DictionaryDetailQuery, nodes []*Dictionary, init func(*Dictionary), assign func(*Dictionary, *DictionaryDetail)) error {
