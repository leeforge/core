...
const (
	...
	FolderTable = "media"
	// FolderInverseTable is the table name for the MediaFolder entity.
	// It exists in this package in order to avoid circular dependency with the "mediafolder" package.
	FolderInverseTable = "media_folders"
...
var (
	...
	PostsPrimaryKey = []string{"post_id", "media_id"}
)
