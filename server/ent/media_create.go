...
func (_c *MediaCreate) SetOwnerDomainID(v uuid.UUID) *MediaCreate {
	_c.mutation.SetOwnerDomainID(v)
	return _c
}

// SetNillableOwnerDomainID sets the "owner_domain_id" field if the given value is not nil.
func (_c *MediaCreate) SetNillableOwnerDomainID(v *uuid.UUID) *MediaCreate {
	if v != nil {
...
func (_c *MediaCreate) SetOwnerID(v uuid.UUID) *MediaCreate {
	_c.mutation.SetOwnerID(v)
	return _c
}

// SetAlias sets the "alias" field.
func (_c *MediaCreate) SetAlias(v string) *MediaCreate {
	_c.mutation.SetAlias(v)
	return _c
}

// SetNillableAlias sets the "alias" field if the given value is not nil.
func (_c *MediaCreate) SetNillableAlias(v *string) *MediaCreate {
	if v != nil {
		_c.SetAlias(*v)
	}
	return _c
...
func (_c *MediaCreate) SetFolderID(v uuid.UUID) *MediaCreate {
	_c.mutation.SetFolderID(v)
	return _c
}

// SetNillableFolderID sets the "folder_id" field if the given value is not nil.
func (_c *MediaCreate) SetNillableFolderID(v *uuid.UUID) *MediaCreate {
	if v != nil {
		_c.SetFolderID(*v)
	}
	return _c
...
func (_c *MediaCreate) SetOwner(v *User) *MediaCreate {
	return _c.SetOwnerID(v.ID)
}

// SetFolder sets the "folder" edge to the MediaFolder entity.
func (_c *MediaCreate) SetFolder(v *MediaFolder) *MediaCreate {
	return _c.SetFolderID(v.ID)
}

// AddPostIDs adds the "posts" edge to the Post entity by IDs.
func (_c *MediaCreate) AddPostIDs(ids ...uuid.UUID) *MediaCreate {
	_c.mutation.AddPostIDs(ids...)
	return _c
}

// AddPosts adds the "posts" edges to the Post entity.
func (_c *MediaCreate) AddPosts(v ...*Post) *MediaCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *MediaCreate) check() error {
	...
	if len(_c.mutation.OwnerIDs()) == 0 {
		return &ValidationError{Name: "owner", err: errors.New(`ent: missing required edge "Media.owner"`)}
	}
	return nil
}
