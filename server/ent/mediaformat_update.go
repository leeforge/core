...
func (_u *MediaFormatUpdate) SetOwnerDomainID(v uuid.UUID) *MediaFormatUpdate {
	_u.mutation.SetOwnerDomainID(v)
	return _u
}

// SetNillableOwnerDomainID sets the "owner_domain_id" field if the given value is not nil.
func (_u *MediaFormatUpdate) SetNillableOwnerDomainID(v *uuid.UUID) *MediaFormatUpdate {
	if v != nil {
...
func (_u *MediaFormatUpdate) ClearOwnerDomainID() *MediaFormatUpdate {
...
func (_u *MediaFormatUpdate) check() error {
	...
	if _u.mutation.MediaCleared() && len(_u.mutation.MediaIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "MediaFormat.media"`)
	}
	return nil
}
...
func (_u *MediaFormatUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.OwnerDomainID(); ok {
		_spec.SetField(mediaformat.FieldOwnerDomainID, field.TypeUUID, value)
	}
	if _u.mutation.OwnerDomainIDCleared() {
		_spec.ClearField(mediaformat.FieldOwnerDomainID, field.TypeUUID)
	}
...
// SetOwnerDomainID sets the "owner_domain_id" field.
func (_u *MediaFormatUpdateOne) SetOwnerDomainID(v uuid.UUID) *MediaFormatUpdateOne {
	_u.mutation.SetOwnerDomainID(v)
	return _u
}
...
// ClearOwnerDomainID clears the value of the "owner_domain_id" field.
func (_u *MediaFormatUpdateOne) ClearOwnerDomainID() *MediaFormatUpdateOne {
	_u.mutation.ClearOwnerDomainID()
	return _u
}
