...
func (_q *OperationLogQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OperationLogQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *OperationLogQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OperationLogQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *OperationLogQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *OperationLogQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(operationlog.FieldCreatedByID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OperationLog.Query().
//		Select(operationlog.FieldCreatedByID).
//		Scan(ctx, &v)
...
func (_q *OperationLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(operationlog.Table, operationlog.Columns, sqlgraph.NewFieldSpec(operationlog.FieldID, field.TypeUUID))
	_spec.From = _q.sql
