...
// was not loaded in eager-loading.
func (e PostEdges) MediaOrErr() ([]*Media, error) {
	if e.loadedTypes[1] {
		return e.Media, nil
	}
...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case post.FieldID, post.FieldCreatedByID, post.FieldUpdatedByID, post.FieldDeletedByID:
...
func (_m *Post) QueryMedia() *MediaQuery {
