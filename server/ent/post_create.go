...
func (_c *PostCreate) AddAuthorIDs(ids ...uuid.UUID) *PostCreate {
	_c.mutation.AddAuthorIDs(ids...)
	return _c
}

// AddAuthor adds the "author" edges to the User entity.
func (_c *PostCreate) AddAuthor(v ...*User) *PostCreate {
...
func (_c *PostCreate) AddMediumIDs(ids ...uuid.UUID) *PostCreate {
	_c.mutation.AddMediumIDs(ids...)
	return _c
}

// AddMedia adds the "media" edges to the Media entity.
func (_c *PostCreate) AddMedia(v ...*Media) *PostCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
