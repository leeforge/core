...
func (_u *PostUpdate) AddAuthorIDs(ids ...uuid.UUID) *PostUpdate {
	_u.mutation.AddAuthorIDs(ids...)
	return _u
}

// AddAuthor adds the "author" edges to the User entity.
func (_u *PostUpdate) AddAuthor(v ...*User) *PostUpdate {
...
func (_u *PostUpdate) AddMediumIDs(ids ...uuid.UUID) *PostUpdate {
	_u.mutation.AddMediumIDs(ids...)
	return _u
}

// AddMedia adds the "media" edges to the Media entity.
func (_u *PostUpdate) AddMedia(v ...*Media) *PostUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PostUpdate) RemoveAuthorIDs(ids ...uuid.UUID) *PostUpdate {
	_u.mutation.RemoveAuthorIDs(ids...)
	return _u
}

// RemoveAuthor removes "author" edges to User entities.
func (_u *PostUpdate) RemoveAuthor(v ...*User) *PostUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PostUpdate) RemoveMediumIDs(ids ...uuid.UUID) *PostUpdate {
	_u.mutation.RemoveMediumIDs(ids...)
	return _u
}

// RemoveMedia removes "media" edges to Media entities.
func (_u *PostUpdate) RemoveMedia(v ...*Media) *PostUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddAuthorIDs adds the "author" edge to the User entity by IDs.
func (_u *PostUpdateOne) AddAuthorIDs(ids ...uuid.UUID) *PostUpdateOne {
	_u.mutation.AddAuthorIDs(ids...)
	return _u
}

// AddAuthor adds the "author" edges to the User entity.
func (_u *PostUpdateOne) AddAuthor(v ...*User) *PostUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddMediumIDs adds the "media" edge to the Media entity by IDs.
func (_u *PostUpdateOne) AddMediumIDs(ids ...uuid.UUID) *PostUpdateOne {
	_u.mutation.AddMediumIDs(ids...)
	return _u
}

// AddMedia adds the "media" edges to the Media entity.
func (_u *PostUpdateOne) AddMedia(v ...*Media) *PostUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveAuthorIDs removes the "author" edge to User entities by IDs.
func (_u *PostUpdateOne) RemoveAuthorIDs(ids ...uuid.UUID) *PostUpdateOne {
	_u.mutation.RemoveAuthorIDs(ids...)
	return _u
}

// RemoveAuthor removes "author" edges to User entities.
func (_u *PostUpdateOne) RemoveAuthor(v ...*User) *PostUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveMediumIDs removes the "media" edge to Media entities by IDs.
func (_u *PostUpdateOne) RemoveMediumIDs(ids ...uuid.UUID) *PostUpdateOne {
	_u.mutation.RemoveMediumIDs(ids...)
	return _u
}

// RemoveMedia removes "media" edges to Media entities.
func (_u *PostUpdateOne) RemoveMedia(v ...*Media) *PostUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
